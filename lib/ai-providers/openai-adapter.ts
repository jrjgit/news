...
export interface OpenAIAdapterConfig extends Record<string, unknown> {
  apiKey?: string
  model?: string
  baseUrl?: string
}

export class OpenAIAdapter extends BaseAIAdapter<OpenAIAdapterConfig> {
  ...
  constructor(config: OpenAIAdapterConfig) {
    ...
    if (!config.apiKey) {
      console.warn('OpenAI API密钥未配置，AI功能将不可用')
      return
    }
